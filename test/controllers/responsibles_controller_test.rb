...
class ResponsiblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsible" do
    assert_difference('Responsible.count') do
      post responsibles_url, params: { responsible: { client_id: @responsible.client_id, company_id: @responsible.company_id } }
    end
  ...
  test "should update responsible" do
    patch responsible_url(@responsible), params: { responsible: { client_id: @responsible.client_id, company_id: @responsible.company_id } }
